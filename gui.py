...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.list_food_log = QtWidgets.QListView(parent=self.page_FoodLog)
        self.list_food_log.setGeometry(QtCore.QRect(90, 100, 451, 291))
        ...
        self.stackedWidgetFitTrack.setCurrentIndex(6)
